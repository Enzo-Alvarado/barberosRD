  ...
  <body>
    <form method="POST" action="login.php" class="form_container">
      <div class="title_container">
        ...
        <span class="subtitle"
          >Inicia sesión para poder disfrutar de todo el contenido y servicios
          que ofrecemos.</span
        >
      </div>
      <br />
      ...
      <input title="Sign In" type="submit" class="sign-in_btn" value="Iniciar Sesión">

      <p class="note">Aún no tienes cuenta? <a href="signup.php">Registrate</a></p>
    </form>
  </body>
</html>